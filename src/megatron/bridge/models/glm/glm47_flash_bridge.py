...
@MegatronModelBridge.register_bridge(
    ...
    model_type="glm47_flash_moe_lite",
)
class GLM47FlashBridge(MegatronModelBridge):
    """Megatron Bridge for GLM 4.7-Flash (MoE Lite).
    ...
    def provider_bridge(self, hf_pretrained: PreTrainedCausalLM) -> MLAModelProvider:
        ...
        # Derive moe_layer_freq from HF config
    ...
    def mapping_registry(self) -> MegatronMappingRegistry:
        """Return the weight mapping registry for GLM 4.7-Flash.

        Uses the same MLA mappings as DeepSeek-V3.
        """
